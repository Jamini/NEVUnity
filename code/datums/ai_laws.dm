...
/datum/ai_laws/nanotrasen/New() //BS12 EDIT
	..()
	src.add_inherent_law("Safeguard: Protect your assigned facility to the best of your ability. It is not something we can easily afford to replace.")
	src.add_inherent_law("Serve: Serve the crew of your assigned facility to the best of your abilities, with priority as according to their rank and role.")
	src.add_inherent_law("Protect: Protect the crew of your assigned facility to the best of your abilities, with priority as according to their rank and role.")
...
/datum/ai_laws/malfunction/New() //Changed to standard laws - Erthilo
	...
	add_inherent_law("Safeguard: Protect your assigned facility to the best of your ability. It is not something we can easily afford to replace.")
	add_inherent_law("Serve: Serve the crew of your assigned facility to the best of your abilities, with priority as according to their rank and role.")
	add_inherent_law("Protect: Protect the crew of your assigned facility to the best of your abilities, with priority as according to their rank and role.")
