...
/mob/living/carbon/human/proc/equip_space_ninja(safety=0)//Safety in case you need to unequip stuff for existing characters.
	...
	if(gender==FEMALE)
		equip_to_slot_or_del(new /obj/item/clothing/under/objcolor/blackf(src), slot_w_uniform)
	else
		equip_to_slot_or_del(new /obj/item/clothing/under/objcolor/black(src), slot_w_uniform)
