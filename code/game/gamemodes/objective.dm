...
datum/objective/harm
	...
	find_target()
		..()
		if(target && target.current)
			explanation_text = "Make an example of [target.current.real_name], the [target.assigned_role]. Break one of their bones, detach one of their limbs or disfigure their face. Make sure they survive the accident."
		else
			explanation_text = "Free Objective"
		return target
...
datum/objective/steal
	...
	var/global/possible_items[] = list(
		...
		"a warden's jumpsuit" = /obj/item/clothing/under/rank/head_of_security,
