...
/obj/machinery/alarm
	...
	req_one_access = list(access_atmospherics, access_engine_equip, access_power)
	var/frequency = 1439
...
/obj/machinery/alarm/server/New()
	..()
	req_access = list(access_rd, access_atmospherics, access_engine_equip, access_power)
