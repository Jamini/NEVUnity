	...
	if(src.HELMET)
		switch(src.targetspecies)
			...
			if(SUIT_UNATHI)
				switch(HELMET.get_department())
					if(RIG_ENG)
						src.HELMET = new /obj/item/clothing/head/helmet/space/rig/unathi()
					if(RIG_ATMOS)
						src.HELMET = new /obj/item/clothing/head/helmet/space/rig/atmos/unathi()
					if(RIG_MEDICAL)
						src.HELMET = new /obj/item/clothing/head/helmet/space/rig/medical/unathi()
					if(RIG_MINING)
						src.HELMET = new /obj/item/clothing/head/helmet/space/rig/mining/unathi()
					if(RIG_SECURITY)
						src.HELMET = new /obj/item/clothing/head/helmet/space/rig/security/unathi()
					if(RIG_ELITE)
						src.HELMET = new /obj/item/clothing/head/helmet/space/rig/elite/unathi()
					if(RIG_SYNDI)
						src.HELMET = new /obj/item/clothing/head/helmet/space/unathi/breacher()
			if(SUIT_SKRELL)
				switch(HELMET.get_department())
					if(RIG_ENG)
	...
	if(src.SUIT)
		switch(src.targetspecies)
			...
			if(SUIT_UNATHI)
				switch(SUIT.get_department())
					if(RIG_ENG)
						src.SUIT = new /obj/item/clothing/suit/space/rig/unathi()
					if(RIG_ATMOS)
						src.SUIT = new /obj/item/clothing/suit/space/rig/atmos/unathi()
					if(RIG_MEDICAL)
						src.SUIT = new /obj/item/clothing/suit/space/rig/medical/unathi()
					if(RIG_MINING)
						src.SUIT = new /obj/item/clothing/suit/space/rig/mining/unathi()
					if(RIG_SECURITY)
						src.SUIT = new /obj/item/clothing/suit/space/rig/security/unathi()
					if(RIG_ELITE)
						src.SUIT = new /obj/item/clothing/suit/space/rig/elite/unathi()
					if(RIG_SYNDI)
						src.SUIT = new /obj/item/clothing/suit/space/unathi/breacher()
			if(SUIT_SKRELL)
				switch(SUIT.get_department())
					if(RIG_ENG)
...
/obj/machinery/suit_fitter/proc/start_Working(mob/user as mob)
	if(src.isWorking) //I'm bored of all these sanity checks
		user << "<font color='red'>Unit is working  -- Aborting.</font>"
		return
	if(src.isopen)
		user << "<font color='red'>Unit doors are open -- Aborting.</font>"
		return
