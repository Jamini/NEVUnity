...
/obj/item/weapon/aiModule/protectStation
	...
	desc = "A 'protect ship' AI module: 'Protect the facility against damage. Anyone you see harming the ship is to be no longer considered human, and is a threat to the ship which must be neutralized.'"
...
/obj/item/weapon/aiModule/protectStation/transmitInstructions(var/mob/living/silicon/ai/target, var/mob/sender)
	..()
	var/law = "Protect the facility against damage. Anyone you see harming the ship is to be no longer considered human, and is a threat to the ship which must be neutralized."
	target << law
