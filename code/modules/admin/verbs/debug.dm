...
/client/proc/callproc()
	...
	spawn(0)
		...
		if(targetselected)
			if(!target)
				usr << "<font objcolor='red'>Error: callproc(): owner of proc no longer exists.</font>"
				return
			if(!hascall(target,procname))
				usr << "<font objcolor='red'>Error: callproc(): target has no such call [procname].</font>"
				return
		...
		usr << "<font objcolor='blue'>[procname] returned: [returnval ? returnval : "null"]</font>"
...
/client/proc/cmd_admin_dress(var/mob/living/carbon/human/M in mob_list)
	...
	switch(dresscode)
		...
		if ("standard space gear")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/under/objcolor/grey(M), slot_w_uniform)
		...
		if ("tournament standard red","tournament standard green") //we think stunning weapon is too overpowered to use it on tournaments. --rastaf0
			if (dresscode=="tournament standard red")
				M.equip_to_slot_or_del(new /obj/item/clothing/under/objcolor/red(M), slot_w_uniform)
			else
				M.equip_to_slot_or_del(new /obj/item/clothing/under/objcolor/green(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/black(M), slot_shoes)
