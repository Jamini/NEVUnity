//Gloves
/obj/item/clothing/gloves/black/fingerless
	desc = "These gloves lack fingertips."
...
/obj/item/clothing/gloves/yellow/reinforced
	desc = "Yellow gloves made for working with electrical currents. They don't look like they'd fit a human."
...
/obj/item/clothing/gloves/latex/reinforced
	desc = "Surgical gloves tailored to accomidate claws. They don't look like they'd fit a human."
	name = "Tailored Surgical Gloves"
	icon_state = "rlatex"
	item_state = "rlatex"
	species_restricted = list("Tajaran","Unathi")

//Tajaran Engineering Hardsuits
