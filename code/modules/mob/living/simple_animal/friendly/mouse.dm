/mob/living/simple_animal/mouse
	...
	density = 0
	var/skincolor //brown, gray and white, leave blank for random
	layer = MOB_LAYER
...
/mob/living/simple_animal/mouse/Life()
	...
	if(!ckey && stat == CONSCIOUS && prob(0.5))
		stat = UNCONSCIOUS
		icon_state = "mouse_[skincolor]_sleep"
		wander = 0
		speak_chance = 0
		//snuffles
...
/mob/living/simple_animal/mouse/New()
	..()
	if(!skincolor)
		skincolor = pick( list("brown","gray","white") )
	icon_state = "mouse_[skincolor]"
	icon_living = "mouse_[skincolor]"
	icon_dead = "mouse_[skincolor]_dead"
	desc = "It's a small [skincolor] rodent, often seen hiding in maintenance areas and making a nuisance of itself."


/mob/living/simple_animal/mouse/proc/splat()
	src.health = 0
	src.stat = DEAD
	src.icon_dead = "mouse_[skincolor]_splat"
	src.icon_state = "mouse_[skincolor]_splat"
	if(client)
