...
/mob/new_player
	...
	proc/AnnounceArrival(var/mob/living/carbon/human/character, var/rank)
		if (ticker.current_state == GAME_STATE_PLAYING)
			var/obj/item/device/radio/intercom/a = new /obj/item/device/radio/intercom(null)// UNITY EDIT Stasis Management Computer, rather than the AI.
			if(character.mind.role_alt_title)
				rank = character.mind.role_alt_title
			a.autosay("[character.real_name],[rank ? " [rank]," : " visitor," ] has awoken from stasis.", "Stasis Management Computer")
			del(a)
	...
	proc/LateChoices()
		...
		if(emergency_shuttle) //In case Nanotrasen decides reposess CentComm's shuttles.
			...
			if(emergency_shuttle.direction == 1 && emergency_shuttle.timeleft() < 30 && emergency_shuttle.alert == 0) // Emergency shuttle is past the point of no recall
